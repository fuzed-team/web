	...
	return (
		<MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
			<AnimationContainer delay={0.1} className="w-full">
				...
				<p className="mt-4">
					At <strong>Fuzed</strong>, we are committed to protecting your
					privacy and safeguarding your personal information, including facial data. This Privacy Policy explains how we collect, use, disclose,
					and safeguard your information when you use our AI face matching platform.
				</p>
				...
				<p className="mt-8 text-muted-foreground">
					...
					personal information including your name, email address, school/university affiliation,
					gender, and profile photos. We also store your account preferences and settings.
				</p>

				<h3 className="text-lg font-medium mt-12">Facial Data and Biometric Information</h3>
				<p className="mt-8 text-muted-foreground">
					When you upload photos to our platform, we process your facial images to extract
					facial embeddings (512-dimensional vectors) using InsightFace AI technology. These embeddings
					are mathematical representations of your facial features used for matching purposes.
					We also analyze facial attributes such as landmarks, pose, quality scores, age estimation,
					and expression detection. Your original photos are securely stored in Supabase Storage.
				</p>
				...
				<p className="mt-8 text-muted-foreground">
					Your profile information and photos are visible to other users when you appear in their
					match results. However, facial embeddings are never shared. Chat is only unlocked when
					both users show mutual interest by generating an AI baby together, ensuring privacy-first connections.
				</p>
				...
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					<li><strong>InsightFace AI</strong> - for facial embedding extraction and analysis</li>
					<li><strong>FAL.AI</strong> - for AI baby image generation</li>
				</ul>
				<p className="mt-4 text-muted-foreground">
					These providers process your data solely for the services we offer and do not retain your images.
				</p>

				<h3 className="text-lg mt-8">Infrastructure Providers</h3>
				<p className="mt-8 text-muted-foreground">
					We use <strong>Supabase</strong> for secure data storage, authentication, and real-time features.
					Your photos and data are stored with industry-standard encryption and access controls.
				</p>

				<h3 className="text-lg mt-8">Legal Requirements</h3>
				<p className="mt-8 text-muted-foreground">
					We may disclose your information if required to do so by law, to protect our rights,
					prevent fraud, or respond to valid requests by public authorities.
				</p>

				<h2 className="text-xl font-medium mt-12">Data Security</h2>
				<p className="mt-8 text-muted-foreground">
					We implement comprehensive security measures to protect your facial data and personal information:
				</p>
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					<li>End-to-end encryption for data transmission</li>
					<li>Secure storage with Supabase's enterprise-grade infrastructure</li>
				...
				<p className="mt-8 text-muted-foreground">
					We retain your personal information, photos, and facial embeddings for as long as
					your account remains active. If you delete your account, we will permanently delete:
				</p>
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
				...
				<p className="mt-4 text-muted-foreground">
					Some anonymized, aggregated data may be retained for analytics and research purposes.
				</p>
				...
				<p className="mt-8 text-muted-foreground">
					You have the right to access, view, and update your personal information and photos.
					You can manage your profile, upload new photos, or select which photo to use for matching
					through your account settings.
				</p>

				<h3 className="text-lg mt-8">Photo Management</h3>
				<p className="mt-8 text-muted-foreground">
					You can upload, delete, or change your default matching photo at any time.
					Deleting a photo will also remove its associated facial embeddings from our system.
				</p>
				...
				<p className="mt-8 text-muted-foreground">
					...
					including photos and facial embeddings. This action is permanent and cannot be undone.
					You can delete your account through profile settings or contact us for assistance.
				</p>

				<h3 className="text-lg mt-8">Opt-Out of Features</h3>
				<p className="mt-8 text-muted-foreground">
					You can choose not to participate in certain features like celebrity matching or
					baby generation. However, core face matching is required to use the platform.
				</p>

				<h2 className="text-xl font-medium mt-12">Biometric Privacy</h2>
				<p className="mt-8 text-muted-foreground">
					We recognize the sensitive nature of facial biometric data. We commit to:
				</p>
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					<li>Only collecting facial data necessary for matching services</li>
					<li>Never selling or sharing your facial embeddings with third parties</li>
				...
				<p className="mt-8 text-muted-foreground">
					...
					facial data or personal information from individuals under 18. If we become aware
					that we have collected data from someone under 18, we will immediately delete all
					associated information, photos, and facial embeddings.
				</p>
				...
				<p className="mt-8 text-muted-foreground">
					...
					and facial data when transferred across borders, in compliance with applicable data
					protection laws.
				</p>
				...
				<p className="mt-8 text-muted-foreground">
					...
					posting the new Privacy Policy on our platform and updating the "Last updated"
					date at the top. Your continued use of the platform after changes constitutes
				...
				<p className="mt-8 text-muted-foreground">
					...
					or how we handle your facial data and personal information, please contact us at:
				</p>
				<p className="mt-4 text-muted-foreground">
					Email: privacy@fuzed.app
				</p>

				<p className="mt-8 font-medium">
					By using Fuzed, you acknowledge that you have read, understood, and
					agree to the terms of this Privacy Policy, including our collection and
					processing of your facial biometric data for AI matching purposes.
				</p>
			</AnimationContainer>
		</MaxWidthWrapper>
	);
