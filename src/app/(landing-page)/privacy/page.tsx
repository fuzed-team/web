	...
	return (
		<MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
			...
			<p className="mt-4">
				...
				and safeguarding your personal information, including facial data. This
				Privacy Policy explains how we collect, use, disclose, and safeguard
				your information when you use our AI face matching platform.
			</p>
			...
			<p className="mt-8 text-muted-foreground">
				...
				school/university affiliation, gender, and profile photos. We also store
			...
			<p className="mt-8 text-muted-foreground">
				When you upload photos to our platform, we process your facial images to
				extract facial embeddings (512-dimensional vectors) using InsightFace AI
				technology. These embeddings are mathematical representations of your
				facial features used for matching purposes. We also analyze facial
				attributes such as landmarks, pose, quality scores, age estimation, and
				expression detection. Your original photos are securely stored in
				Supabase Storage.
			</p>
			...
			<h2 className="text-xl font-medium mt-12">How We Use Your Information</h2>
			...
			<p className="mt-8 text-muted-foreground">
				Your profile information and photos are visible to other users when you
				appear in their match results. However, facial embeddings are never
				shared. Chat is only unlocked when both users show mutual interest by
				generating an AI baby together, ensuring privacy-first connections.
			</p>
			...
			<ul className="list-disc ml-8 text-muted-foreground mt-4">
				<li>
					<strong>InsightFace AI</strong> - for facial embedding extraction and
					analysis
				</li>
				<li>
			...
			<p className="mt-8 text-muted-foreground">
				...
				authentication, and real-time features. Your photos and data are stored
				with industry-standard encryption and access controls.
			</p>

			<h3 className="text-lg mt-8">Legal Requirements</h3>
			<p className="mt-8 text-muted-foreground">
				We may disclose your information if required to do so by law, to protect
				our rights, prevent fraud, or respond to valid requests by public
				authorities.
			</p>

			<h2 className="text-xl font-medium mt-12">Data Security</h2>
			<p className="mt-8 text-muted-foreground">
				We implement comprehensive security measures to protect your facial data
			...
			<p className="mt-8 text-muted-foreground">
				You have the right to access, view, and update your personal information
				and photos. You can manage your profile, upload new photos, or select
				which photo to use for matching through your account settings.
			</p>

			<h3 className="text-lg mt-8">Photo Management</h3>
			<p className="mt-8 text-muted-foreground">
				You can upload, delete, or change your default matching photo at any
				time. Deleting a photo will also remove its associated facial embeddings
				from our system.
			</p>
			...
			<p className="mt-8 text-muted-foreground">
				...
				associated data, including photos and facial embeddings. This action is
				permanent and cannot be undone. You can delete your account through
			...
			<p className="mt-8 text-muted-foreground">
				...
				matching or baby generation. However, core face matching is required to
				use the platform.
			</p>
			...
			<p className="mt-8 text-muted-foreground">
				...
				under 18, we will immediately delete all associated information, photos,
				and facial embeddings.
			</p>
			...
			<p className="mt-8 text-muted-foreground">
				...
				your personal information and facial data when transferred across
				borders, in compliance with applicable data protection laws.
			</p>
			...
			<p className="mt-8 text-muted-foreground">
				...
				Policy or how we handle your facial data and personal information,
