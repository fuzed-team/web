	...
	return (
		<MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
			<AnimationContainer delay={0.1} className="w-full">
				...
				<p className="mt-4">
					Welcome to <strong>Fuzed</strong>. These Terms of Service ("Terms")
					govern your access to and use of our AI-powered face matching
					platform, including all features such as celebrity matching, AI baby
					generation, and real-time chat. By using Fuzed, you agree to be bound
					by these Terms.
				</p>
				...
				<p className="mt-8 text-muted-foreground">
					By accessing, browsing, or using Fuzed, you acknowledge that you have
				...
				<p className="mt-8 text-muted-foreground">
					You must be at least 18 years old to use Fuzed. By using our platform,
				...
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					...
					<li>
						You are not prohibited from using our services under any applicable
						laws
					</li>
				...
				<h2 className="text-xl font-medium mt-12">
					4. Photo Upload and Facial Data
				</h2>
				...
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					...
					<li>
						Photos must not contain nudity, violence, or offensive content
					</li>
					<li>Photos must not violate any third-party rights or privacy</li>
					<li>
						You grant us permission to process and analyze your facial data for
						matching purposes
					</li>
				</ul>
				...
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					...
					<li>
						Analysis of facial attributes (age, gender, pose, quality, etc.)
					</li>
					<li>
						Comparison of your facial features with other users and celebrities
					</li>
					<li>Display of your photos to other users in match results</li>
				</ul>

				<h2 className="text-xl font-medium mt-12">
					5. Platform Features and Usage
				</h2>

				<h3 className="text-lg mt-8">Face Matching</h3>
				<p className="mt-8 text-muted-foreground">
					Our face matching service uses AI to find users with similar facial
					features. You understand that:
				</p>
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					<li>
						Matching is based on algorithmic analysis and may not be perfect
					</li>
				...
				<p className="mt-8 text-muted-foreground">
					The AI baby generator creates predictions using FAL.AI technology. You
					acknowledge that:
				</p>
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					<li>
						Generated images are artistic predictions, not accurate forecasts
					</li>
					<li>Results are for entertainment purposes only</li>
					<li>
						Generated babies are stored and visible to both users involved
					</li>
				...
				<p className="mt-8 text-muted-foreground">
					Our platform includes real-time chat functionality. When using chat,
					you agree to:
				</p>
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
				...
				<p className="mt-8 text-muted-foreground">You may NOT use Fuzed to:</p>
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
				...
				<p className="mt-8 text-muted-foreground">
					All content on Fuzed, including design, text, graphics, logos,
					algorithms, and software, is owned by us or our licensors and is
				...
				<p className="mt-8 text-muted-foreground">
					You retain ownership of the photos you upload. By uploading content,
				...
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					...
					<li>
						Use aggregated, non-identifiable data for research and improvement
					</li>
				</ul>
				...
				<p className="mt-8 text-muted-foreground">
					Fuzed is provided "AS IS" and "AS AVAILABLE" without warranties of any
				...
				<p className="mt-8 text-muted-foreground">
					To the fullest extent permitted by law, Fuzed and its affiliates,
				...
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
					<li>
						<strong>Supabase</strong> - for authentication, storage, and
						database
					</li>
					<li>
						<strong>InsightFace AI</strong> - for facial recognition and
						analysis
					</li>
					<li>
				...
				<p className="mt-8 text-muted-foreground">
					Your use of Fuzed is also governed by our{" "}
					<Link href="/privacy" className="text-primary hover:underline">
						Privacy Policy
					</Link>
					, which explains how we collect, use, and protect your personal
					information and facial data. Please review it carefully to understand
					our privacy practices.
				</p>

				<h2 className="text-xl font-medium mt-12">11. Indemnification</h2>
				<p className="mt-8 text-muted-foreground">
					You agree to indemnify, defend, and hold harmless Fuzed and its
				...
				<p className="mt-8 text-muted-foreground">
					Any disputes arising from these Terms or your use of Fuzed shall be
				...
				<p className="mt-4 text-muted-foreground">
					Your continued use of Fuzed after changes constitutes acceptance of
					the modified Terms.
				</p>

				<h2 className="text-xl font-medium mt-12">14. Termination</h2>
				<p className="mt-8 text-muted-foreground">
					You may terminate your account at any time through profile settings.
					Upon termination:
				</p>
				<ul className="list-disc ml-8 text-muted-foreground mt-4">
				...
				<p className="mt-4 text-muted-foreground">
					We may retain some information as required by law or for legitimate
					business purposes.
				</p>
				...
				<p className="mt-8 text-muted-foreground">
					...
					agreement between you and Fuzed.
				</p>
				...
				<p className="mt-4 text-muted-foreground">Email: legal@fuzed.app</p>
