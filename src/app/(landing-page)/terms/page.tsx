	...
	return (
		<MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
			...
			<p className="mt-4">
				...
				govern your access to and use of our AI-powered face matching platform,
				including all features such as celebrity matching, AI baby generation,
				and real-time chat. By using Fuzed, you agree to be bound by these
				Terms.
			</p>
			...
			<p className="mt-8 text-muted-foreground">
				Our platform includes real-time chat functionality. When using chat, you
				agree to:
			</p>
			<ul className="list-disc ml-8 text-muted-foreground mt-4">
			...
			<p className="mt-8 text-muted-foreground">
				You retain ownership of the photos you upload. By uploading content, you
			...
			<ul className="list-disc ml-8 text-muted-foreground mt-4">
				<li>
					<strong>Supabase</strong> - for authentication, storage, and database
				</li>
				<li>
					<strong>InsightFace AI</strong> - for facial recognition and analysis
				</li>
				<li>
			...
			<p className="mt-4 text-muted-foreground">
				...
				privacy policies. We are not responsible for any third-party services or
				their performance.
			</p>
			...
			<p className="mt-4 text-muted-foreground">
				Your continued use of Fuzed after changes constitutes acceptance of the
				modified Terms.
			</p>
