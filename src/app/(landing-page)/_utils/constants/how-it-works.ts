...
export const HOW_IT_WORKS_STEPS: Step[] = [
  {
    ...
    description: "Upload a clear photo of your face and let our AI analyze your unique facial features",
    details: [
  ...
  },
  {
    ...
    description: "Browse through your lookalikes and see which celebrities you match with",
    details: [
  ...
  },
  {
    ...
    number: 3,
    title: "Connect & Chat",
    description: "Generate AI babies with matches and unlock real-time chat to start connecting",
    details: [
